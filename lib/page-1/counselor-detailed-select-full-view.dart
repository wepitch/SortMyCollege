...
class _CounsellorBookingListState extends State<CounsellorBookingList> {
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(
                  20 * fem, 18.79 * fem, 15 * fem, 18 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          2 * fem, 20.08 * fem, 10.99 * fem, 0 * fem),
                      width: 11.01 * fem,
                      height: 20 * fem,
                      child: Image.asset(
                    ...
                    child: Stack(
                      children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border:
                                        Border.all(color: Color(0x70000000)),
                                    color: Color(0xffffffff),
                                    borderRadius:
                        ...
                        Positioned(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(8.52 * fem, 3.83 * fem,
                                10.27 * fem, 4.49 * fem),
                            width: 50.11 * fem,
                            height: 18.33 * fem,
                            decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(
                              14.74 * fem, 0 * fem, 2 * fem, 8.03 * fem),
                          width: double.infinity,
                          height: 39 * fem,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Container(
                                // group117ced (733:22)
                                margin: EdgeInsets.fromLTRB(0 * fem, 7.32 * fem,
                                    49.58 * fem, 5.7 * fem),
                                height: double.infinity,
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.center,
  ...
  void onTapgotocounsellor(BuildContext context) {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => Dashboardsg1()));
  }
}
