        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20*fem, 60.79*fem, 30*fem, 15.71*fem),
              width: double.infinity,
                ...
                child: Stack(
                  children: [
                            ...
                            child: TextButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    // group25Cyf (730:13)
                                    margin: EdgeInsets.fromLTRB(20*fem, 30*fem, 10*fem, 10.73*fem),
                                    width: 400*fem,
                                    height:350*fem,
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        // group18PPF (730:36)
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 14.43*fem, 58.16*fem, 0*fem),
                                                                        child: Column(
                                                                          crossAxisAlignment: CrossAxisAlignment.start,
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              child: Text(
                                                                                "${getData?[index].personalInfo.name}",
                                                                                style: SafeGoogleFont (
                                                                                  'Inter',
                                                                                  fontSize: 20*ffem,
                                                                            ...
                                                                            Text(
                                                                              ...
                                                                              "${getData?[index].qualifications[index]}",
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        // locationbtd (730:68)
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.5*fem, 0.03*fem),
                                                                        width: 15*fem,
                                                                        height: 15*fem,
                                                                        child: Image.asset(
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child: Text(
                                                                          "${getData?[index].personalInfo.location.city}",
                                                                          style: SafeGoogleFont (
                                                                            'Inter',
                                                                            fontSize: 12*ffem,
                                                                            fontWeight: FontWeight.w400,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  margin: EdgeInsets.fromLTRB(10.79*fem, 0*fem, 8.88*fem, 11.5*fem),
                                                                  width: double.infinity,
                                                                  child: Row(
                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                    children: [
                                                                      Container(
                                                                        // group1324p9 (730:74)
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 8.5*fem, 33.29*fem, 0*fem),
                                                                        height: 33*fem,
                                                                        child: Row(
                                                                          crossAxisAlignment: CrossAxisAlignment.center,
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              padding: EdgeInsets.fromLTRB(9.55*fem, 1.45*fem, 7.45*fem, 9.55*fem),
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 1.26*fem, 4.13*fem, 0*fem),
                                                                        width: 10.41*fem,
                                                                        height: 10.41*fem,
                                                                        child: Image.asset(
                                                                ...
                                                                Container(
                                                                  // group39fzH (730:39)
                                                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 11.91*fem, 0*fem),
                                                                  width: double.infinity,
                                                                  height: 30*fem,
                                                                  decoration: BoxDecoration (
                                                                    borderRadius: BorderRadius.circular(99*fem),
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  margin: EdgeInsets.fromLTRB(0*fem, 5.35*fem, 23.41*fem, 3.21*fem),
                                                                  height: double.infinity,
                                                                  child: Column(
                                                                    crossAxisAlignment: CrossAxisAlignment.center,
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child: Text(
                                                                          "${getData?[index].workExperience}"" year",
                                                                          style: SafeGoogleFont (
                                                                            'Inter',
                                                                            fontSize: 13*ffem,
                                                                            fontWeight: FontWeight.w700,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        // JfB (730:62)
                                                                        margin: EdgeInsets.fromLTRB(2.42*fem, 0*fem, 0*fem, 0*fem),
                                                                        child: Text(
                                                                          "${getData?[index].totalAppointedSessions}",
                                                                          style: SafeGoogleFont (
                                                                            'Inter',
                                                                            fontSize: 13*ffem,
                                                                            fontWeight: FontWeight.w700,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        // sVK (730:63)
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 3.09*fem, 0*fem),
                                                                        child: Text(
                                                                          "${getData?[index].rewardPoints} +",
                                                                          style: SafeGoogleFont (
                                                                            'Inter',
                                                                            fontSize: 13*ffem,
                                                                            fontWeight: FontWeight.w700,
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        // kfT7 (730:64)
                                                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.34*fem, 0*fem),
                                                                        child: Text(
                                                                          '2.5K',
                                                                          style: SafeGoogleFont (
                                                                            'Inter',
                    ...
                    Positioned(
                      ...
                      top: 794*fem,
                      child: Container(
                        padding: EdgeInsets.fromLTRB(40*fem, 12*fem, 35.5*fem, 10*fem),
                        width: 460*fem,
                        height: 67*fem,
                        decoration: BoxDecoration (
