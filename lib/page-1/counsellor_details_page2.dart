...
class CounsellorDetialsPage2 extends StatefulWidget {
  final String id;
  const CounsellorDetialsPage2({required this.id, super.key});
  @override
  State<CounsellorDetialsPage2> createState() => _CounsellorDetialsPage2State();
}

class _CounsellorDetialsPage2State extends State<CounsellorDetialsPage2> {
  bool visible = false;
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    margin: EdgeInsets.fromLTRB(
                                                                        ...
                                                                        0 * fem),
                                                                    child: Text(
                                                                      counsellorDetailController.cousnellorlist_detail[0].personalSessionPrice ==
                                                                              null
                                                                          ? "N/A"
                                                                          : counsellorDetailController
                                                                              .cousnellorlist_detail[0]
