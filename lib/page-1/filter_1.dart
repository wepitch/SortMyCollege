...
import 'package:myapp/page-1/filter2.dart';

class Filter_1 extends StatefulWidget {
  @override
  State<Filter_1> createState() => _Filter_1State();
}

class _Filter_1State extends State<Filter_1> {
  @override
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => Filter2()),(route) => false);
                                    },
                                    child: Container(
                                      width: double.infinity,
                                      height: 59*fem,
