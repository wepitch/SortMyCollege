                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      height: 24*fem,
                      child: Image.asset(
                        'assets/page-1/images/more-1-1-QYx.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 134*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-KSY.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                TextButton(
                                  ...
                                  child: Container(
                                    ...
                                    child: Container(
                                      ...
                                      padding: EdgeInsets.fromLTRB(6*fem, 21*fem, 6*fem, 21*fem),
                                      width: double.infinity,
                                      height: double.infinity,
                                      decoration: BoxDecoration (
                                        border: Border.all(color: Color(0x1c000000)),
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              height: 15*fem,
                                              child: Image.asset(
                                                'assets/page-1/images/tick-u4L.png',
                                                fit: BoxFit.cover,
                                              ),
                                            ),
                                            Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(5*fem, 22*fem, 111*fem, 20*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 17*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-2at.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 185*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-Ub2.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 152*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-M6Y.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(5*fem, 22*fem, 104*fem, 20*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 17*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-whS.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 139*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-Cxp.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 164*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-uRa.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
                                ...
                                Container(
                                  ...
                                  padding: EdgeInsets.fromLTRB(6*fem, 22*fem, 147*fem, 21*fem),
                                  width: double.infinity,
                                  decoration: BoxDecoration (
                                    border: Border.all(color: Color(0x1c000000)),
                                    color: Color(0xffffffff),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        height: 15*fem,
                                        child: Image.asset(
                                          'assets/page-1/images/tick-S1n.png',
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                      Container(
