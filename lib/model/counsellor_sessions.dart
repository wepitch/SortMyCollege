...
class Sessions {
  ...
  Sessions({this.id, this.sessionCounselor, this.sessionUser, this.sessionDate, this.sessionTime, this.sessionDuration, this.sessionType, this.sessionPrice, this.sessionStatus, this.sessionSlots, this.sessionLink, this.createdAt, this.updatedAt, this.sessionAvailableSlots, this.v, this.sessionMassagedDate});
